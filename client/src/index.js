    ...
    <Provider store={store}>
        <Router>
            <div>
                ...
                <Route key="/service/result" path="/service/result" component={ServiceResult} />
                <Route key="login" path="/login" component={Login} /> 
                <Route key="signup" path="/signup" component={Signup} /> 
                <Route key="partneraccount" path="/partneraccount" component={PartnerAccount} /> 
                <Route key="serviceprovider" path="/serviceprovider" component={ServiceProvider} /> 
                <Footer />
            </div>
        </Router>
    </Provider>, 
