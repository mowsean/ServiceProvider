        ...
        <div className="container-fluid p-3 p-md-5">
          ...
          <p>
            ...
            <Link to="/" target="_blank" rel="noopener">
              @mow
            </Link>. Maintained by the <Link to="/">core team</Link> with the
            help of <Link to="/">our contributors</Link>.
          </p>
          <p>
            Currently v4.0.0. Code licensed{" "}
            <Link to="/" target="_blank" rel="license noopener">
              MIT
            </Link>, docs{" "}
            <Link to="/" target="_blank" rel="license noopener">
              CC BY 3.0
