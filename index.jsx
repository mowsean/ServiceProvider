...
export default function CompleteFloorPlanPPStep({
  ...
  const handlePhoneChange = (phoneNum, country, event, formattedValue) => {
                  ...
                  <div className="col-span-1">
                    ...
                    <div className="mt-1 w-full rounded-md shadow-sm">
                      <PhoneInput
                        ...
                        dropdownStyle={{ display: 'flex', flexDirection: 'column-reverse', bottom: '45px' }}
                        onBlur={handleInputBlur}
                        value={phoneNo}
                        className="flex-1 block w-full min-w-0 rounded sm:text-sm border-gray-300"
                        onChange={handlePhoneChange}
                        isValid={phoneNo == '' ? true : phoneNo != null && phoneNo != '' && isValidPhoneNumber(phoneNo)}
