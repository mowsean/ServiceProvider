...
import CustomCountryDropDown from '@components/app/CustomCountryDropDown';
...
export default function CompleteFloorPlanPPStep({
  ...
  const onSubmit = async formData => {
    if (phoneNo) {
      ...
      const cCode = oldPhoneNumber ? oldPhoneNumber.country : selectedCountry
      setSelectedCountry(cCode);
      const newPhoneNumber = new parsePhoneNumber(oldPhoneNumber?.nationalNumber, cCode);
