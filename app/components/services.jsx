                    ...
                    <div className="col-md-6">
                        <div className="card flex-md-row mb-4 box-shadow h-md-250">
                            <div className="card-body d-flex flex-column align-items-start">
                                <strong className="d-inline-block mb-2 text-success">Logo</strong>
                                <h3 className="mb-0">
                                    <Link className="text-dark" to="/">Food Bank</Link>
                                </h3>
                                <div className="mb-1 text-muted">Mar 18</div>
                                <p className="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                <Link to="/">Book Now!</Link>
                    ...
                    <div className="col-md-6">
                        <div className="card flex-md-row mb-4 box-shadow h-md-250">
                            <div className="card-body d-flex flex-column align-items-start">
                                <strong className="d-inline-block mb-2 text-success">Logo</strong>
                                <h3 className="mb-0">
                                    <Link className="text-dark" to="/">Hotels</Link>
                                </h3>
                                <div className="mb-1 text-muted">Mar 18</div>
                                <p className="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                <Link to="/">Book Now!</Link>
                    ...
                    <div className="col-md-6">
                        <div className="card flex-md-row mb-4 box-shadow h-md-250">
                            <div className="card-body d-flex flex-column align-items-start">
                                <strong className="d-inline-block mb-2 text-success">Logo</strong>
                                <h3 className="mb-0">
                                    <Link className="text-dark" to="/">Care Taker</Link>
                                </h3>
                                <div className="mb-1 text-muted">Mar 18</div>
                                <p className="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                <Link to="/">Book Now!</Link>
                    ...
                    <div className="col-md-6">
                        <div className="card flex-md-row mb-4 box-shadow h-md-250">
                            <div className="card-body d-flex flex-column align-items-start">
                                <strong className="d-inline-block mb-2 text-success">Logo</strong>
                                <h3 className="mb-0">
                                    <Link className="text-dark" to="/">Doctors</Link>
                                </h3>
                                <div className="mb-1 text-muted">Mar 18</div>
                                <p className="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                <Link to="/">Book Now!</Link>
                    ...
                    <div className="col-md-6">
                        <div className="card flex-md-row mb-4 box-shadow h-md-250">
                            <div className="card-body d-flex flex-column align-items-start">
                                <strong className="d-inline-block mb-2 text-success">Logo</strong>
                                <h3 className="mb-0">
                                    <Link className="text-dark" to="/">Education & Training</Link>
                                </h3>
                                <div className="mb-1 text-muted">Mar 18</div>
                                <p className="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                <Link to="/">Book Now!</Link>
